...
export const PlaygroundTile: React.FC<PlaygroundTileProps> = ({
  ...
  return (
    <div
    className={`flex flex-col rounded-xl border-gray-100 border shadow-xl text-gray-500 bg-${backgroundColor} ${className}`}
    >
      {title && (
        <div
          className="flex items-center justify-center text-xs uppercase py-2 tracking-wider text-blue-700"
          style={{
